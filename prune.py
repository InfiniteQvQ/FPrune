...
def ww_sparsity_llama2_7b_split(args, model, device=torch.device("cuda:0"),
    ...
    importance = np.array([ 0.6626,0.6386,0,0.6853,0.6841,0.6879,0.6948,0.6833,0.6833,0.6927,0.6942,0.6961,0.6929,0.6948,
                           0.6972,0.6916,0.6935,0.6948,0.6967,0.6954,0.6941,0.6958,0.6971,0.6983,0.6966,0.6997,0.6959,0.6952,
                           0.6973,0.6899,0.6366,0.6579])

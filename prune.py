...
def ww_sparsity_test_3b(args, model, device=torch.device("cuda:0"),
                         s1=0.8, s2=1.2, ratios=None, prune_n=0, prune_m=0,
                         weight_esd=0.8, eps=1e-8):
    c = [0.5379492, 0.58894163, 0.63762003, 0.6368102, 0.65913594, 0.654498, 0.6361238, 0.59785956, 0.60311633, 0.5735346, 0.5927234, 0.5950572, 0.6047597, 0.6167859, 0.6247751, 0.6746634, 0.66511834, 0.722731, 0.7984232, 0.7512119, 0.8027262, 0.8333436, 0.7780572, 0.77099407, 0.8207943, 0.86117935, 0.84019035, 0.85054654, 0.7954785, 0.8386537, 0.76552427, 0.66907597]
    a = []
    for i in c:
        for j in range(7):
            a.append(i)

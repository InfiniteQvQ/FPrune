...
def ww_sparsity_test_3b(args, model, device=torch.device("cuda:0"),
                         s1=0.8, s2=1.2, ratios=None, prune_n=0, prune_m=0,
                         weight_esd=0.8, eps=1e-8):
    c = [0.50765258, 0.66459963, 0.53299251, 0.69610037 ,0.70424549, 0.70276499,
    0.69610022, 0.68203017, 0.6838812,  0.67314378, 0.68017887, 0.68091889,
    0.68425171, 0.6886947,  0.69165661, 0.7101702,  0.70646222 ,0.72756654,
    0.75533943, 0.7379342,  0.75680216, 0.76790779, 0.74791867 ,0.74493175,
    0.76346284, 0.77827516, 0.77051124, 0.77419525 ,0.7538321 , 0.76968855,
    0.46283269, 0.68695749]
    a = []
    for i in c:
        for j in range(7):
            a.append(i)

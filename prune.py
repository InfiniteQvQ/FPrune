...
def ww_sparsity_test_3b(args, model, device=torch.device("cuda:0"),
                         s1=0.8, s2=1.2, ratios=None, prune_n=0, prune_m=0,
                         weight_esd=0.5, eps=1e-8):
    a = [0.5378521680831909, 0.8067782521247864, 0.7709823846817017, 0.6736106872558594, 0.6547078490257263, 0.6298697590827942, 0.6402539610862732, 0.6396210789680481, 0.6516038179397583, 0.6598682999610901, 0.6687270402908325, 0.669675350189209, 0.6756173372268677, 0.6841525435447693, 0.6858218312263489, 0.6805891394615173, 0.6653094291687012, 0.6854155659675598, 0.6925766468048096, 0.6961325407028198, 0.7014862895011902, 0.711900532245636, 0.7274946570396423, 0.7342473864555359, 0.7514146566390991, 0.7587866187095642, 0.761052131652832, 0.7607026696205139, 0.7641938328742981, 0.7596399188041687, 0.7582458853721619, 0.7416697144508362]
    c = []
    for i in a:
        for j in range(7):
            c.append(i)

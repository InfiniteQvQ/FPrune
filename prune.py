...
def ww_sparsity_test_3b(args, model, device=torch.device("cuda:0"),
                         s1=0.8, s2=1.2, ratios=None, prune_n=0, prune_m=0,
                         weight_esd=0.8, eps=1e-8):
    c = [0.60572963, 0.63881014, 0.63649858, 0.63238708 ,0.64776475, 0.64379074,
        0.62590766, 0.58815451, 0.59312204, 0.56431041, 0.58318699, 0.585174,
        0.59411554, 0.60603759, 0.61398563, 0.66366087, 0.65372588 ,0.71035567,
        0.78486853, 0.73817388, 0.78884268, 0.81864785, 0.76499859, 0.75705053,
        0.80672576, 0.84646589, 0.8256023,  0.83553756, 0.7808955 , 0.84422576,
        0.86585457, 0.73939288]
    a = []
    for i in c:
        for j in range(7):
            a.append(i)

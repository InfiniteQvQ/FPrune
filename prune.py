...
def ww_sparsity_llama2_7b_split(args, model, device=torch.device("cuda:0"),
    ...
    for i in range(32):
        #Q
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.144640 * 7)
        #K
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.143680 * 7)
        #V
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.143380 * 7)
        #OUT
        res.append(layerwise_pruning_ratios_esd[i*7] *  0.142900 * 7)
        #GATE
        res.append(layerwise_pruning_ratios_esd[i*7] *    0.141460 * 7)
        #UP
        res.append(layerwise_pruning_ratios_esd[i*7] *   0.141730 * 7)
        #DOWN
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.142210 * 7)

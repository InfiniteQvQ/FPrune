...
def ww_sparsity_llama2_7b_split(args, model, device=torch.device("cuda:0"),
    ...
    for i in range(32):
        #Q
        res.append(layerwise_pruning_ratios_esd[i*7] *  0.151771 * 7)
        #K
        res.append(layerwise_pruning_ratios_esd[i*7] *0.146971* 7)
        #V
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.145471 * 7)
        #OUT
        res.append(layerwise_pruning_ratios_esd[i*7] *  0.143071 * 7)
        #GATE
        res.append(layerwise_pruning_ratios_esd[i*7] *   0.135871 * 7)
        #UP
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.137221* 7)
        #DOWN
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.139621* 7)

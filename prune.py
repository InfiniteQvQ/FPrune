...
def ww_sparsity_llama_rl(args, model, device=torch.device("cuda:0"),
    ...
    a = np.array([0.6431155800819397, 0.580086886882782, 0.6795459389686584, 0.7654055953025818, 0.7037902474403381, 
                  ...
                  0.6420567631721497, 0.7123979926109314, 0.68129962682724, 0.7240214943885803, 0.6811814308166504, 
                  0.6815359592437744, 0.7567269802093506, 0.723733127117157, 0.7331490516662598, 0.8701303601264954, 
                  0.7121002078056335, 0.6777119040489197, 0.697460949420929, 0.651827335357666, 0.7080539464950562, 
                  0.6970732808113098, 0.6321396827697754])
    res = []
    for i in a:
        for j in range(7):
            res.append(i)

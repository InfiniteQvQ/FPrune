...
def ww_sparsity_test_3b(args, model, device=torch.device("cuda:0"),
                         s1=0.8, s2=1.2, ratios=None, prune_n=0, prune_m=0,
                         weight_esd=0.8, eps=1e-8):
    c = [0.56073856, 0.6090677, 0.63332206, 0.6325191, 0.6546864, 0.650075, 0.6318232, 0.5938148, 0.5990317, 0.5696478, 0.58870405, 0.5910141, 0.6006445, 0.61258215, 0.62050873, 0.6700541, 0.66054064, 0.7177231, 0.7928589, 0.7459365, 0.79701936, 0.82734364, 0.7723989, 0.76530975, 0.81468844, 0.85473293, 0.83387667, 0.8441232, 0.789454, 0.8322955, 0.81880987, 0.7130552]
    a = []
    for i in c:
        for j in range(7):
            a.append(i)

...
def ww_sparsity_llama2_7b_split(args, model, device=torch.device("cuda:0"),
    ...
    for i in range(32):
        #Q
        res.append(layerwise_pruning_ratios_esd[i*7] *0.147730 * 7)
        #K
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.145106 * 7)
        #V
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.144286 * 7)
        #OUT
        res.append(layerwise_pruning_ratios_esd[i*7] *  0.142974 * 7)
        #GATE
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.139038 * 7)
        #UP
        res.append(layerwise_pruning_ratios_esd[i*7] *  0.139776 * 7)
        #DOWN
        res.append(layerwise_pruning_ratios_esd[i*7] *0.141088 * 7)

...
def ww_sparsity_llama2_7b_split(args, model, device=torch.device("cuda:0"),
    ...
    for i in range(32):
        #Q
        res.append(layerwise_pruning_ratios_esd[i*7] *0.148206 * 7)
        #K
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.145326 * 7)
        #V
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.144426 * 7)
        #OUT
        res.append(layerwise_pruning_ratios_esd[i*7] *   0.142986 * 7)
        #GATE
        res.append(layerwise_pruning_ratios_esd[i*7] *  0.138666 * 7)
        #UP
        res.append(layerwise_pruning_ratios_esd[i*7] *  0.139476 * 7)
        #DOWN
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.140916 * 7)

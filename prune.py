...
def ww_sparsity_llama2_7b_split(args, model, device=torch.device("cuda:0"),
    ...
    for i in range(32):
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.165 * 7)
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.155* 7)
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.142 * 7)
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.142 * 7)
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.13 * 7)
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.165 * 7)
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.101 * 7)

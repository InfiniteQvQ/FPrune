...
def ww_sparsity_llama2_7b_split(args, model, device=torch.device("cuda:0"),
    ...
    for i in range(32):
        #Q
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.147314 * 7)
        #K
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.144914 * 7)
        #V
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.144164 * 7)
        #OUT
        res.append(layerwise_pruning_ratios_esd[i*7] *   0.142964 * 7)
        #GATE
        res.append(layerwise_pruning_ratios_esd[i*7] *   0.139364 * 7)
        #UP
        res.append(layerwise_pruning_ratios_esd[i*7] *  0.140039 * 7)
        #DOWN
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.141239 * 7)

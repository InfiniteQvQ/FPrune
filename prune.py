...
def ww_sparsity_llama2_7b_split(args, model, device=torch.device("cuda:0"),
    ...
    for i in range(32):
        #Q
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.150583 * 7)
        #K
        res.append(layerwise_pruning_ratios_esd[i*7] *0.146423* 7)
        #V
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.145123 * 7)
        #OUT
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.143043 * 7)
        #GATE
        res.append(layerwise_pruning_ratios_esd[i*7] *   0.136803* 7)
        #UP
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.137973* 7)
        #DOWN
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.140053* 7)

...
def ww_sparsity_test_3b(args, model, device=torch.device("cuda:0"),
                         s1=0.8, s2=1.2, ratios=None, prune_n=0, prune_m=0,
                         weight_esd=0.5, eps=1e-8):
    a = [0.8843472599983215, 0.5895648002624512, 0.6211477518081665, 0.7366827130317688, 0.760342538356781, 0.7919754981994629, 0.7719642519950867, 0.7612781524658203, 0.7496060132980347, 0.7364925146102905, 0.7286763191223145, 0.7305189967155457, 0.7211599349975586, 0.7128672003746033, 0.7148643732070923, 0.7254742383956909, 0.7427456378936768, 0.721269965171814, 0.715664267539978, 0.7110351920127869, 0.7026933431625366, 0.6874723434448242, 0.6698034405708313, 0.6601260900497437, 0.6394407153129578, 0.6308172345161438, 0.6282318830490112, 0.6279835104942322, 0.6229493618011475, 0.6275508999824524, 0.6276058554649353, 0.6476467251777649]c = []
    c = []
    for i in a:
        for j in range(7):
            c.append(i)

...
def ww_sparsity_llama2_7b_split(args, model, device=torch.device("cuda:0"),
    ...
    for i in range(32):
        #Q
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.147017 * 7)
        #K
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.144777 * 7)
        #V
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.144077 * 7)
        #OUT
        res.append(layerwise_pruning_ratios_esd[i*7] *  0.142957 * 7)
        #GATE
        res.append(layerwise_pruning_ratios_esd[i*7] *   0.139597 * 7)
        #UP
        res.append(layerwise_pruning_ratios_esd[i*7] *  0.140227 * 7)
        #DOWN
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.141347 * 7)

...
def ww_sparsity_llama2_7b_split(args, model, device=torch.device("cuda:0"),
    ...
    importance = np.array([0.0534,0.877,1,0.0209,0.0227,0.0173,0.0075,0.0239,0.0238,0.0104,0.0082,0.0056,0.0102,0.0074,
                           0.004,0.012,0.0093,0.0074,0.0048,0.0066,0.0084,0.0061,0.0118,0.0024,0.0048,0.0004,0.0059,
                            0.0068,0.0038,0.0144,0.0906,0.0601 ])

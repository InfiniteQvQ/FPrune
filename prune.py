...
def ww_sparsity_test_3b(args, model, device=torch.device("cuda:0"),
                         s1=0.8, s2=1.2, ratios=None, prune_n=0, prune_m=0,
                         weight_esd=0.5, eps=1e-8):
    a = [0.5332587957382202, 0.7998881936073303, 0.7713215351104736, 0.6668206453323364, 0.6454204320907593, 0.6168085336685181, 0.6349087357521057, 0.6445741653442383, 0.6551316380500793, 0.666992723941803, 0.6740624308586121, 0.6723957061767578, 0.6808609962463379, 0.6883617043495178, 0.6865552067756653, 0.6769587397575378, 0.6613368391990662, 0.680761456489563, 0.6858317255973816, 0.6900187134742737, 0.697563886642456, 0.7113312482833862, 0.7273126840591431, 0.7360658049583435, 0.7547755837440491, 0.7625755071640015, 0.7649139761924744, 0.7651386260986328, 0.7696920037269592, 0.765529990196228, 0.7654802203178406, 0.7473533153533936]
    c = []
    for i in a:
        for j in range(7):
            c.append(i)

...
def ww_sparsity_test_3b(args, model, device=torch.device("cuda:0"),
                         s1=0.8, s2=1.2, ratios=None, prune_n=0, prune_m=0,
                         weight_esd=0.8, eps=1e-8):
    c = [0.5047822, 0.5596507, 0.643875, 0.643055, 0.6656115, 0.6609348, 0.6423825, 0.60374606, 0.60906094, 0.5791912, 0.59857297, 0.6009415, 0.61074847, 0.62290365, 0.6309841, 0.6813714, 0.6717804, 0.73001915, 0.806521, 0.75888926, 0.8110315, 0.8420755, 0.78629214, 0.77926654, 0.8296802, 0.8705611, 0.8493789, 0.8598949, 0.8042461, 0.847907, 0.687974, 0.60506976]
    a = []
    for i in c:
        for j in range(7):
            a.append(i)

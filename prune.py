...
def ww_sparsity_llama2_7b_split(args, model, device=torch.device("cuda:0"),
    ...
    for i in range(32):
        #Q
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.136 * 7)
        #K
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.136* 7)
        #V
        ...
        #GATE
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.153 * 7)
        #UP
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.149 * 7)
        #DOWN
        res.append(layerwise_pruning_ratios_esd[i*7] * 0.149 * 7)

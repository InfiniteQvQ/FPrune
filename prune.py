...
def ww_sparsity_test_3b(args, model, device=torch.device("cuda:0"),
                         s1=0.8, s2=1.2, ratios=None, prune_n=0, prune_m=0,
                         weight_esd=0.5, eps=1e-8):
    a = [0.8760753870010376, 0.5840502381324768, 0.6229207515716553, 0.7286560535430908, 0.7491824626922607, 0.7761539816856384, 0.7648778557777405, 0.7655650973320007, 0.7525531649589539, 0.7435787320137024, 0.7339591383934021, 0.7329294085502625, 0.7264769077301025, 0.717208743095398, 0.715395987033844, 0.721078097820282, 0.7376702427864075, 0.7158371806144714, 0.7080610394477844, 0.7041996717453003, 0.698386013507843, 0.6870773434638977, 0.670143723487854, 0.6628110408782959, 0.6441691517829895, 0.6361640095710754, 0.6337039470672607, 0.6340833902359009, 0.6302923560142517, 0.6352373361587524, 0.6367511749267578, 0.6547511219978333]
    c = []
    for i in a:
        for j in range(7):
            c.append(i)

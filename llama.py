...
def prune_wanda(args, model, tokenizer, device=torch.device("cuda:0"), prune_n=0, prune_m=0, ratios=None):
    res = [0.4074437618255615, 0.4411410689353943, 0.4510934054851532, 0.4505268633365631, 0.43439315259456635, 0.43439315259456635, 0.43439315259456635, 0.43439315259456635, 0.43439315259456635, 0.43439315259456635, 0.43439315259456635, 0.43439315259456635, 0.4353879590829213, 0.4353879590829213, 0.4353879590829213, 0.4862886766592662, 0.4862886766592662, 0.4862886766592662, 0.5545178651809692, 0.5545178651809692, 0.5545178651809692, 0.5613838036855062, 0.5613838036855062, 0.5613838036855062, 0.5943632125854492, 0.5943632125854492, 0.5974039435386658, 0.5974039435386658, 0.5773546099662781, 0.5773546099662781, 0.6010161638259888, 0.5226446986198425]
    r = []
    for i in res:
        for j in range(7):
            r.append(i)

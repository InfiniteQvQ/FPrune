...
def prune_wanda(args, model, tokenizer, device=torch.device("cuda:0"), prune_n=0, prune_m=0, ratios=None):
    res = [0.4016808569431305, 0.43490156531333923, 0.44471311569213867, 0.4441545903682709, 0.4282490760087967, 0.4282490760087967, 0.4282490760087967, 0.4282490760087967, 0.4282490760087967, 0.4282490760087967, 0.4282490760087967, 0.4282490760087967, 0.42922982573509216, 0.42922982573509216, 0.42922982573509216, 0.4794105887413025, 0.4794105887413025, 0.4794105887413025, 0.5466747283935547, 0.5466747283935547, 0.5466747283935547, 0.5534435907999674, 0.5534435907999674, 0.5534435907999674, 0.5859565138816833, 0.5859565138816833, 0.5889542400836945, 0.5889542400836945, 0.5691884756088257, 0.5691884756088257, 0.5925153493881226, 0.515252411365509]
    r = []
    for i in res:
        for j in range(7):
            r.append(i)

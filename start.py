...
from lib.prune import prune_wanda, prune_sparsegpt, prune_magnitude, prune_wanda_ww2, prune_sparsegpt_ww2, prune_magnitude_ww2, check_sparsity 
...
def main():
    ...
    if args.sparsity_ratio != 0:
        ...
        # Pruning with our layerwise pruning ratios
            ...
            prune_wanda_ww2(args, model, tokenizer, device)

        elif args.prune_method == "magnitude_ww":
            prune_magnitude_ww2(args, model, tokenizer, device)

        elif args.prune_method == "sparsegpt_ww":
            prune_sparsegpt_ww2(args, model, tokenizer, device)
